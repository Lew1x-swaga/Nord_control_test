...
PIN 4 цифры — от соседнего кабинета, не от атакующего LAN. Трафик класса без TLS: в школьной LAN это принятый риск MVP. Не делать «шифрования» самописным XOR.

## UI

См. [ui.md](ui.md). Пароль выхода ученика = PIN класса после Join.
